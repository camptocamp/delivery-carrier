    ...
    def _compute_package_type_domain(self):
        ...
        for wizard in self:
            ...
            if not package_carrier:
                continue
            # follow the falsy domain from the parent compute. this means the filtering
            # is disabled
            if not wizard.package_type_domain:
                continue
            ...
            domain = AND([wizard.package_type_domain, package_carrier_domain])
